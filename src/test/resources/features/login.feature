...
Funcionalidade: Permitir realizar login no sistema de gest�o de usu�rios
  ...
  Contexto: 
    ...
    E eu informar "tollel" na linha 17 coluna 44
    E senha "tollel" na linha 18 coluna 44
    E teclar enter

  Cenário: Validação de tela de login
    Dado estou seja apresentada na tela a informação de login "Login" na linha 17 coluna 44
    Quando eu informar "filipe" na linha 17 coluna 44
    E senha "1234" na linha 18 coluna 44
    E teclar enter
  ...
  Cenário: Falha ao logar no sistema de gestão de usuários
    ...
    Dado estou seja apresentada na tela a informação de login "SISTEMA DE GESTAO DE USUARIO" na linha 15 coluna 21
